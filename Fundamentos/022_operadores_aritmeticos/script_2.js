// estão também disponíveis operadores únarios de incremento e decremento,
...
// mas se fizer assim
console.log(num++, num); // 101 primeiro e só depois 101 + 1 = 102

// decremento antes da apresentação do valor
console.log(--num); // 102 - 1 = 101
// mas se fizer assim:
console.log(num--, num); // 101 primeiro e só depois 101 - 1 = 100
